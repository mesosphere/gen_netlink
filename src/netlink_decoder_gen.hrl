...
decode_nl_msgtype_ipset(?IPSET_CMD_NONE) ->
    none;

decode_nl_msgtype_ipset(?IPSET_CMD_PROTOCOL) ->
    protocol;

decode_nl_msgtype_ipset(?IPSET_CMD_CREATE) ->
    create;

decode_nl_msgtype_ipset(?IPSET_CMD_DESTROY) ->
    destroy;

decode_nl_msgtype_ipset(?IPSET_CMD_FLUSH) ->
    flush;

decode_nl_msgtype_ipset(?IPSET_CMD_RENAME) ->
    rename;

decode_nl_msgtype_ipset(?IPSET_CMD_SWAP) ->
    swap;

decode_nl_msgtype_ipset(?IPSET_CMD_LIST) ->
    list;

decode_nl_msgtype_ipset(?IPSET_CMD_SAVE) ->
    save;

decode_nl_msgtype_ipset(?IPSET_CMD_ADD) ->
    add;

decode_nl_msgtype_ipset(?IPSET_CMD_DEL) ->
    del;

decode_nl_msgtype_ipset(?IPSET_CMD_TEST) ->
    test;

decode_nl_msgtype_ipset(?IPSET_CMD_HEADER) ->
    header;

decode_nl_msgtype_ipset(?IPSET_CMD_TYPE) ->
    type;

decode_nl_msgtype_ipset(?IPSET_CMD_RESTORE) ->
    restore;

decode_nl_msgtype_ipset(?IPSET_CMD_HELP) ->
    help;

decode_nl_msgtype_ipset(?IPSET_CMD_VERSION) ->
    version;

decode_nl_msgtype_ipset(?IPSET_CMD_QUIT) ->
    quit;

decode_nl_msgtype_ipset(?IPSET_CMD_COMMIT) ->
    commit;

decode_nl_msgtype_ipset(Value) ->
    Value.
...
encode_nl_msgtype_ipset(none) ->
    ?IPSET_CMD_NONE;

encode_nl_msgtype_ipset(protocol) ->
    ?IPSET_CMD_PROTOCOL;

encode_nl_msgtype_ipset(create) ->
    ?IPSET_CMD_CREATE;

encode_nl_msgtype_ipset(destroy) ->
    ?IPSET_CMD_DESTROY;

encode_nl_msgtype_ipset(flush) ->
    ?IPSET_CMD_FLUSH;

encode_nl_msgtype_ipset(rename) ->
    ?IPSET_CMD_RENAME;

encode_nl_msgtype_ipset(swap) ->
    ?IPSET_CMD_SWAP;

encode_nl_msgtype_ipset(list) ->
    ?IPSET_CMD_LIST;

encode_nl_msgtype_ipset(save) ->
    ?IPSET_CMD_SAVE;

encode_nl_msgtype_ipset(add) ->
    ?IPSET_CMD_ADD;

encode_nl_msgtype_ipset(del) ->
    ?IPSET_CMD_DEL;

encode_nl_msgtype_ipset(test) ->
    ?IPSET_CMD_TEST;

encode_nl_msgtype_ipset(header) ->
    ?IPSET_CMD_HEADER;

encode_nl_msgtype_ipset(type) ->
    ?IPSET_CMD_TYPE;

encode_nl_msgtype_ipset(restore) ->
    ?IPSET_CMD_RESTORE;

encode_nl_msgtype_ipset(help) ->
    ?IPSET_CMD_HELP;

encode_nl_msgtype_ipset(version) ->
    ?IPSET_CMD_VERSION;

encode_nl_msgtype_ipset(quit) ->
    ?IPSET_CMD_QUIT;

encode_nl_msgtype_ipset(commit) ->
    ?IPSET_CMD_COMMIT;

encode_nl_msgtype_ipset(Value) when is_integer(Value) ->
    Value.
